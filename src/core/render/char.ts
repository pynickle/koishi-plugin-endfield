        ...
        <div class="column is-6">
            <div class="box is-shadowless p-2 mb-0" style="background:#f9f9f9; border:1px solid #eee; display:flex; align-items:center; border-bottom: 3px solid ${borderColor}; height: 100%;">
                ...
                <div style="overflow:hidden; flex:1;">
                    ...
                    <span class="tag is-white is-light is-small" style="border:1px solid #ddd; height:1.4em; min-height:unset;">Lv.${item.equipData.level.value}</span>
                </div>
            </div>
        </div>
      `;
  ...
  <head>
      ...
      <style>
          ...
          .main-card {
              ...
              background: white;
              overflow: hidden;
              /* 可选：如果希望整个卡片即使内容少也有高度，可设 min-height */
              min-height: 550px;
          }
          .col-poster {
              width: 40%;
      ...
      <div class="main-card">
          ...
          <div class="col-content">
              ...
              <div>
                  ...
                  <div class="media" style="align-items:center;">
                      <figure class="media-left mb-0">
                          <p class="image is-56x56" style="background:#fafafa; padding:2px; border:1px solid #eee; border-radius:4px;">
                              <img src="${cleanUrl(d.weapon.weaponData.iconUrl)}">
                          </p>
                      </figure>
                      <div class="media-content">
                          <p class="title is-6 has-text-dark mb-1">${d.weapon.weaponData.name}</p>
              ...
              <div>
                   ...
                   <div class="columns is-multiline is-mobile is-gapless mobile-grid">
                       ${equipHtml}
                   </div>
              </div>
              ...
              <div>
                  ...
                  <div class="is-flex is-align-items-center has-background-light p-2" style="border-radius:4px;">
                       <span class="icon has-text-grey mr-2"><i class="fas fa-medkit"></i></span>
